...
= How can I add new animation effects? =
 - detailed instructions on installing additional animation profiles.

= I have installed the plugin, but its Countdown doesn't appear in available widgets list.
...
= 1.4.3 =
* Bug fix - counter appeared momentary before being hidden if counter display mode selected had limitations on display time before / after event
